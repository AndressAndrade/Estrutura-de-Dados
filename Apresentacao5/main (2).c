...
void insertProcess(processes* prcs) {
    ...
    printf("Ok, você escolheu: inserir processo! Preciso que você me informe o seguinte:\n");
...
void showMenu(processes* prcs) {
    ...
    printf("Escolha uma opção no menu abaixo:\n\n"
                ...
                "2 - Remover processo através do ID\n"
                "3 - Priorizar mercado\n"
                "4 - Listar processo\n"
    ...
    switch(option) {
        ...
        break;
        case 2:
            printf("\nQual o ID do processo que você quer remover?");
            scanf("%i", &auxID);
            processRemoveByID(prcs, auxID);
            showMenu(prcs);
        break;
        case 3:
            printf("\nQual ID do mercado que você quer priorizar?");
            scanf("%i", &auxID);
        ...
        case 5:
            ...
            printf("Processos de exemplo carregados!\n");
            showMenu(prcs);
        break;
        case 0:
            exit(2);
